      ...
      <div className="flex items-start justify-between gap-6">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-2">
            We&apos;re here to help — raise a ticket, call or email support.
          </p>
      ...
      <div className="mt-6 grid grid-cols-12 gap-6">
        <div className="col-span-7 space-y-6">
              ...
              <div className="pr-2">
                ...
                <div className="mt-8 bg-gradient-to-br from-purple-50 to-white rounded-lg p-6 border shadow-sm">
                  ...
                  <p className="text-sm text-slate-600 mt-2">
                    Can’t find the answer? Send us an email and we’ll get back
              ...
              <div>
                <div className="space-y-3">
                  {faqs.map((f, i) => (
                    <div
                      key={i}
                      className="bg-white border rounded-lg shadow-sm p-0"
                    >
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md border">
            ...
            <p className="text-sm text-slate-500 mt-2">
              You can call, email, or raise a ticket below. Fastest way is to
              call during help hours.
            </p>

            <div className="mt-4 grid grid-cols-3 gap-3">
              <a
                href="tel:1800123456"
                className="flex items-center justify-center gap-2 py-3 bg-white border rounded-lg text-center text-indigo-600 hover:shadow"
              >
          ...
          <div className="mt-4">
            <div className="bg-white rounded-2xl p-4 shadow-md border">
              ...
              <form onSubmit={submitTicket} className="mt-4 space-y-3">
                ...
                {statusMsg && (
                  <div className="text-sm text-emerald-600">{statusMsg}</div>
                )}
