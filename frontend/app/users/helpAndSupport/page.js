  ...
  const [faqs] = useState([
    {
      ...
      a: "Go to Profile → Security and choose Reset Password, or use the Forgot Password link on login.",
    },
    {
      q: "How do I track a shipment?",
      a: "Open the Trips tab and select the shipment to see live location and ETA.",
    },
    {
      q: "How can I contact the shipper?",
      a: "Open the shipment details and use the contact info provided for the shipper or driver.",
    },
    {
      q: "How to update my payment method?",
      a: "Go to Wallet → Payment Methods and add or edit your card/bank details.",
    },
  ]);
                    ...
                    <div>
                      ...
                      <div className="mt-2 border rounded-lg p-3 flex items-center justify-between">
                        ...
                        <button
                          type="button"
                          onClick={() =>
                            document.getElementById("usr-hs-attach").click()
                          }
