...
export default function UserProfile() {
  ...
  function submitEdit(e) {
    ...
    // Password update: require current password and confirmation match
    if (editPassword) {
      if (!editCurrentPassword) {
        alert("Enter current password to change password");
        return;
      }
      if (editCurrentPassword !== password) {
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-8">
          ...
          <EditProfileModal
            ...
            editCurrentPassword={editCurrentPassword}
            setEditCurrentPassword={setEditCurrentPassword}
